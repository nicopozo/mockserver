...
//
//	mockgen -destination=../utils/test/mocks/rule_repository_mock.go -package=mocks -source=./rule_repository.go
//
...
func (mr *MockRuleRepositoryMockRecorder) Delete(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuleRepositoryMockRecorder) Get(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockRuleRepository)(nil).Get), ctx, key)
}

// Search mocks base method.
func (m *MockRuleRepository) Search(ctx context.Context, params map[string]any, paging model.Paging) (*model.RuleList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRuleRepositoryMockRecorder) Search(ctx, params, paging any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRuleRepositoryMockRecorder) SearchByMethodAndPath(ctx, method, path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
